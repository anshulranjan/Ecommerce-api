...
exports.create = async (req, res) => {
    try{
        const {images,title, price, discount, delivery, quantity, subcategory} = req.body.values;
        req.body.slug = slugify(title);
        const{slug} = req.body;
        const newProduct = await new Product({images,title,slug, description:req.body.description, discount,delivery,subcategory,category: req.body.category, gender: req.body.gender, brand : req.body.brand, price, quantity, color:req.body.color, shipping:req.body.shipping}).save();
        res.json(newProduct);
    }
    catch(err) {
        console.log(err);
