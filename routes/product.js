...
const {create, listAll, remove, read, update, list, productStar, extractProductByCategory, readCategoryProduct,extractProductBySubs,readSubProduct, searchFilters, getCountbyBrand} = require('../controllers/product');
